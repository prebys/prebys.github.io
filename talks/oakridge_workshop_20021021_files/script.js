...
var ENDSHOW_MESG="End of slide show, click to exit.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=29, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   ...
   new hrefList("slide0058.htm", 1, 2),
   new hrefList("slide0030.htm", 1, 3),
   new hrefList("slide0023.htm", 1, 4),
   new hrefList("slide0024.htm", 1, 5),
   new hrefList("slide0049.htm", 1, 6),
   new hrefList("slide0040.htm", 1, 7),
   new hrefList("slide0039.htm", 1, 8),
   new hrefList("slide0034.htm", 1, 9),
   new hrefList("slide0050.htm", 1, 10),
   new hrefList("slide0051.htm", 1, 11),
   new hrefList("slide0072.htm", 1, 12),
   new hrefList("slide0062.htm", 1, 13),
   new hrefList("slide0063.htm", 1, 14),
   new hrefList("slide0064.htm", 1, 15),
   new hrefList("slide0055.htm", 1, 16),
   new hrefList("slide0073.htm", 1, 17),
   new hrefList("slide0070.htm", 1, 18),
   new hrefList("slide0071.htm", 1, 19),
   new hrefList("slide0065.htm", 1, 20),
   new hrefList("slide0066.htm", 1, 21),
   new hrefList("slide0057.htm", 1, 22),
   new hrefList("slide0067.htm", 1, 23),
   new hrefList("slide0042.htm", 1, 24),
   new hrefList("slide0043.htm", 1, 25),
   new hrefList("slide0059.htm", 1, 26),
   new hrefList("slide0060.htm", 1, 27),
   new hrefList("slide0061.htm", 1, 28),
   new hrefList("slide0068.htm", 1, 29)
);
